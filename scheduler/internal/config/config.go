...
type Config struct {
	...
	BackuperVersion string `env:"BACKUPER_VERSION" envDefault:"ashadrinnn/mysqlbackuper:0.0.1-0"`
	RestorerVersion string `env:"RESTORER_VERSION" envDefault:"sveb00/mysqlrestorer:0.0.1-1"`
